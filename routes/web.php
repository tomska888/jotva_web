...
Route::get('/',  ["uses"=>"ProductsController@index", "as"=> "jotva"]);

Route::get('/jotva', function () {
    return view('welcome');
});

//pagrindinis
Route::get('jotva', ["uses"=>"ProductsController@index", "as"=> "jotva"]);

//istorija
Route::get('jotva/istorija', ["uses"=>"ProductsController@istorija", "as"=> "istorija"]);

//motinos_diena
Route::get('jotva/motinos_diena', ["uses"=>"ProductsController@motinos_diena", "as"=> "motinos_diena"]);

//velines
Route::get('jotva/velines', ["uses"=>"ProductsController@velines", "as"=> "velines"]);

//kiti_renginiai
Route::get('jotva/kiti_renginiai', ["uses"=>"ProductsController@kiti_renginiai", "as"=> "kiti_renginiai"]);
